...
class TourWholesaleDatatable extends Ui
{
    ...
    public function groupName($data)
    {
    	...
    	return '<div class="media">'.
			'<div class="pic-wrap mr-2" style="width: 48px;"><div class="pic squared" ref="image_url" data-type="image">'.$picture.'</div></div>'.
