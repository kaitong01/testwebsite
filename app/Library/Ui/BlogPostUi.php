...
class BlogPostUi extends Ui
{
    ...
    public function keys()
    {
    	...
    	$key[] = array('id'=>'name', 'label'=>'บทความ', 'cls'=>'td-name');
    ...
    public function _groupname($data)
    {
    	...
    	return '<div class="media">
			...
			<div class="media-body">'.
				...
				'<div class="y-ellipsis clamp-2"><span ref="description"> ประเภทบทความ : '. $this->fn->q('text')->type_blogs($data['category_id']).'</span></div>'.
			'</div>
		</div>';
    }
