...
<div class="container-fluid" data-plugin="PageBanners">
	<div class="col-lg-8 col-md-12 col-sm-12">

		<div class="col-lg-8 col-md-12 col-sm-12">


			<form class="insertform" method="post" action="{{route('banners.store')}}" enctype="multipart/form-data" enctype="multipart/form-data">
				@csrf
		...
		<div class="col-lg-8 col-md-12 col-sm-12">
			<div class="cardlist">
				<div class="card" style="width: rem;">
					...
					<div class="card-body">
						<a href="{{action('BannersController@delete',$value['id'])}}" class="btn btn-danger btn-block delpic"><i class="fa fa-trash"></i> ลบรูปภาพ</a>
					</div>
				</div>
			</div>
