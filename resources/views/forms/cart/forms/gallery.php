...
$gallery = [];
if( !empty($series->gallery) ){

    $dataGallery = json_decode($series->gallery, 1);
...
$gallery = '<div data-plugin="seriesProtosForm" data-options="'.htmlentities(json_encode([
    'data'=> $gallery
])).'">

    <div id="gallery_fieldset" class="control-group">
        <div class="controls">
