...
$arr['title'] = 'ลบประเภทแพคเกจทัวร์';
$arr['title'] .= '<br>'.$item['name'];

$arr['form'] = '<form  method="post" action="'.asset( 'tours/category/'.$item['id'] ).'" data-plugin="formSubmit"></form>';
...
$arr['body'] .= "<li>ข้อมูลประเภทแพคเกจนี้จะถูกลบออกไปด้วย</li>";
...
$arr['bottom_msg'] = '<label class="checkbox"><input type="checkbox" name="confirm" value="1"><span class="ml-2">ตกลง ฉันเข้าใจ</span></label>';
